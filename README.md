...
```bash
npm install react-particle-vaporize
```
...
```tsx
import { ParticlesProvider, Vaporize, type VaporizeRef } from "react-particle-vaporize";
...
```tsx
import { ParticlesProvider } from "react-particle-vaporize";
...
```tsx
import { Vaporize, type VaporizeRef } from "react-particle-vaporize";
...
```tsx
import { VaporizeDev } from "react-particle-vaporize";
